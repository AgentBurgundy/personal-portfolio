export default function OnMind() {
  ...
  return (
    <div className="mt-8 flex h-32 w-[90%] flex-col rounded-xl bg-white pt-[16px] pl-[12px] pr-[16px] pb-[10px] shadow-sm lg:w-2/4">
      <div className="flex w-full flex-row">
        ...
        />
        <input
          className="ml-2 w-full rounded-full"
          style={{
          ...
          placeholder="What's on your mind, Recruiter?"
        />
      </div>
      <div className="mt-[12px] flex w-full flex-row justify-evenly border-t-[1px] border-t-gray-300 pt-[8px]">
        <a className="flex flex-row rounded-xl py-[8px] px-[24px] hover:bg-gray-400">
          <svg
            viewBox="0 0 24 24"
            width="1em"
            height="1em"
            style={{ height: '24px', width: '24px', fill: '#F3425F' }}
          >
        ...
        <a className="flex flex-row rounded-xl py-[8px] px-[24px] hover:bg-gray-400">
          <svg
            ...
            width="1em"
            height="1em"
            style={{ height: '24px', width: '24px', fill: '#45BD62' }}
          >
            <g fill-rule="evenodd" transform="translate(-444 -156)">
              <g>
                <path
        ...
        <a className="flex flex-row rounded-xl py-[8px] px-[24px] hover:bg-gray-400">
          <svg
            ...
            width="1em"
            height="1em"
            style={{ height: '24px', width: '24px', fill: '#F7B928' }}
          >
            <g fill-rule="evenodd" transform="translate(-444 -156)">
              <g>
                <path
